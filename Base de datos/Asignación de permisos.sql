...
grant insert on Hatchat.RespondeClase to Alumno;
...
grant select (ci,apodo,nombre,contraseña,resSeguridad,foto,activo,id) on Hatchat.Usuario to Alumno;
...
grant update (apodo,contraseña,resSeguridad,foto,activo,id) on Hatchat.usuario to Alumno;
...
grant insert on Hatchat.respondeclase2 to Docente;
...
grant select (ci,apodo,nombre,contraseña,apellido,resSeguridad,foto,activo,id) on Hatchat.usuario to Docente;
...
grant insert (estado) on Hatchat.mensaje to Docente;
grant insert (apodo,contraseña,resSeguridad,foto,activo,id) on Hatchat.usuario to Docente;
grant insert (dictando) on Hatchat.asignaturaDictada to Docente;
...
grant insert (ci,nombre,contraseña,apellido,segApellido,resSeguridad,foto,activo,id) on Hatchat.usuario to Administrador;
...
grant select on Hatchat.respondeclase to Administrador;
grant select on Hatchat.respondeclase2 to Administrador;
grant select on Hatchat.responde to Administrador;

grant update (apodo,nombre,contraseña,apellido,segApellido,resSeguridad,foto,activo,id) on Hatchat.usuario to Administrador;
